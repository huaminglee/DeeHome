...
{
    public partial class ManagerOrderList : BaseUserControl
    {
        ...
        private void GetDataSource(int _index, int _pageSize)
        {
            DataSet ds = null;
            int totalRecords = 0;
            ds = orderManager.GetAllOrdersByOrderStatus(_index, _pageSize, txtSearch.Text.Replace(" ", ""), orderStatus);
            totalRecords = orderManager.GetAllOrdersCountByOrderStatus(_index, _pageSize, txtSearch.Text.Replace(" ", ""), orderStatus);
            datas = ds;
        ...
        private void DesignerManagerOrderList_Load(object sender, EventArgs e)
        {
